        ...
        <div>
          ...
          <div className="flex flex-col mt-8">
            <div className="flex flex-row items-center justify-between text-xs">
              <span
                className="font-bold">{searchResult.length > 0 ? `Users (${searchResult.length})` : 'No users found'}</span>
            </div>
          ...
          <div className="flex justify-center mt-4">
            <button onClick={handleDisplayUsers} className="bg-green-500 text-white font-semibold p-2 mt-2 rounded">
